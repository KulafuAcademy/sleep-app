...
export default function Home() {
  ...
  if (screen === "select") {
    return (
      <div className="fixed inset-0 bg-[radial-gradient(circle_at_top,_#141518_0%,_#0A0B0D_45%,_#030405_100%)] text-white flex items-start justify-center px-6 py-6 overflow-y-auto max-lg:landscape:items-start max-lg:landscape:overflow-y-auto max-lg:landscape:py-4">
        {/*
        ...
        */}
        <div className="relative z-10 mt-0 w-full max-w-sm hibiki-desktop-scale h-auto min-h-[min(740px,calc(100dvh-48px))] rounded-[32px] border border-[#2A2D33] bg-[#111315] backdrop-blur-md shadow-2xl overflow-hidden md:translate-y-0 max-lg:landscape:h-auto max-lg:landscape:max-h-none max-lg:landscape:translate-y-0 max-lg:landscape:overflow-visible ">

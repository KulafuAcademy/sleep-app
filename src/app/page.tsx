        ...
        <div className="relative z-10 mt-[env(safe-area-inset-top)] w-full max-w-sm min-h-[720px] rounded-[32px] border border-[#2A2D33] bg-[#111315] backdrop-blur-md shadow-2xl overflow-hidden">
          ...
          <div className="px-6 pb-6">
            ...
            <button
              ...
              className="mt-6 w-full rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md py-4 text-base font-medium text-white/60 transition-all duration-200 hover:bg-white/8 hover:scale-[1.03]"
              >
              {selectedSound

    ...
    return (
      <div className="relative min-h-[100dvh] bg-[radial-gradient(circle_at_top,_#1f2a44_0%,_#0d1321_45%,_#05070d_100%)] text-white flex items-center justify-center px-6 py-0 overflow-hidden">
        ...
        */}
        ...
        <div className="relative z-10 mt-0 w-full max-w-sm min-h-[760px] translate-y-6 rounded-[32px] border border-[#2A2D33] bg-[#111315] backdrop-blur-md shadow-2xl overflow-hidden md:translate-y-0">
...
>
  ...
  return (
    <div className="relative min-h-[100dvh] bg-[radial-gradient(circle_at_top,_#141518_0%,_#0A0B0D_45%,_#030405_100%)] text-white flex items-center justify-center px-6 py-0 overflow-hidden">
      ...
      <div className="relative z-10 mt-0 w-full max-w-sm h-[760px] translate-y-6 rounded-[32px] border border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl overflow-hidden md:translate-y-0">
        <div className="px-6 pt-6">
          <button
            onClick={() => {
              pauseWaveLayerTestImmediately();

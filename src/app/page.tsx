...
// =====================================================
  ...
  if (screen === "select") {
    return (
     <div className="hibiki-scroll-shell fixed inset-0 bg-[radial-gradient(circle_at_top,_#141518_0%,_#0A0B0D_45%,_#030405_100%)] text-white flex items-center justify-center px-6 overflow-hidden max-md:portrait:overflow-y-auto max-md:portrait:pt-6 max-lg:landscape:overflow-y-auto max-lg:landscape:py-4">
        {/*
        ...
        */}
        <div className="relative z-10 mt-0 w-full max-w-sm hibiki-desktop-scale h-[min(740px,calc(100dvh-48px))] translate-y-8 rounded-[32px] border border-[#2A2D33] bg-[#111315] backdrop-blur-md shadow-2xl overflow-hidden md:translate-y-0 max-md:portrait:translate-y-0 max-lg:landscape:h-auto max-lg:landscape:max-h-none max-lg:landscape:translate-y-0 max-lg:landscape:overflow-visible ">
  ...
  if (screen === "soundscape") {
    return (
      <div className="hibiki-scroll-shell min-h-screen max-md:portrait:min-h-[100dvh] bg-[radial-gradient(circle_at_top,_#141518_0%,_#0A0B0D_45%,_#030405_100%)] text-white flex items-center justify-center px-6 py-0 overflow-hidden max-lg:landscape:overflow-y-auto max-lg:landscape:py-4">
        <div className="relative w-full max-w-sm hibiki-desktop-scale h-[min(740px,calc(100dvh-48px))] translate-y-8 rounded-[32px] border border-[#2A2D33] bg-[#111315] backdrop-blur-md overflow-hidden md:translate-y-0 max-lg:landscape:h-auto max-lg:landscape:max-h-none max-lg:landscape:translate-y-0 max-lg:landscape:overflow-visible">
          {/* 👇ここに追加（Backボタン） */}
          <div className="px-6 pt-6">
            <button
              onClick={() => {

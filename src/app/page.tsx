...
export default function Home() {
  ...
  if (screen === "select") {
    ...
    <div className="min-h-[100dvh] bg-[radial-gradient(circle_at_top,_#1f2a44_0%,_#0d1321_45%,_#05070d_100%)] text-white flex items-center justify-center px-6 overflow-hidden landscape:min-h-[100svh] landscape:items-start landscape:overflow-y-auto landscape:py-4">
        {/*
...
>
  ...
  if (screen === "player") {
    return (
      <div className="relative min-h-[100dvh] bg-[radial-gradient(circle_at_top,_#141518_0%,_#0A0B0D_45%,_#030405_100%)] text-white flex items-center justify-center px-6 py-0 overflow-hidden landscape:items-start landscape:overflow-y-auto landscape:py-4">
        {selectedSound && (
          <>
